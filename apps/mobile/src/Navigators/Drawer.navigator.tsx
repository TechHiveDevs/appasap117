...
import ListFollowerScreen from "../Entities/Follower/List.follower.screen";
import ShowFollowerScreen from "../Entities/Follower/Show.follower.screen";
import ListPostsScreen from "../Entities/Posts/List.posts.screen";
import ShowPostsScreen from "../Entities/Posts/Show.posts.screen";
  ...
  return (
    <Stack.Navigator {...stackrops}>
      ...
      />
        ...
        <Stack.Screen
            name="ListFollowerScreen"
            component={ListFollowerScreen}
            options={screenOptions}
          />
          <Stack.Screen
          name="ShowFollowerScreen"
          component={ShowFollowerScreen}
          options={screenOptions}
        />
